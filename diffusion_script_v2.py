...
HYBRID DATA ARCHITECTURE PATCH APPLIED
...
def run_upscale_phase(temp_dir, final_dir):
    ...
    for filename in tqdm(files, desc="Standardizing"):
        ...
        # 🟢 ARCHITECTURE PATCH 1: Anchor files (original reference photos) are now safely passed through to final output
        # if "anchor_" in filename: continue
...
def main(args):
    ...
    # 🟢 ARCHITECTURE PATCH 2: Both modes target the exact same output folder
    ...
    # 🟢 ARCHITECTURE PATCH 3: We strictly APPEND to the final folder, we do NOT delete it.
